...
export const api = {
  ...
  siteAssignments: (siteId) => request(`/api/sites/${siteId}/assignments`),
  assignableSiteUsers: (siteId) => request(`/api/sites/${siteId}/assignable-users`),
  assignToSite: (siteId, userId) => request(`/api/sites/${siteId}/assignments`, json('POST', { userId })),
  unassignFromSite: (siteId, userId) => request(`/api/sites/${siteId}/assignments/${userId}`, json('DELETE')),
  activeSites: () => request('/api/active-sites'),
  ...
  addTaskDependency: (taskId, dependsOnTaskId) => request(`/api/tasks/${taskId}/dependencies`, json('POST', { dependsOnTaskId })),
  removeTaskDependency: (taskId, dependsOnTaskId) => request(`/api/tasks/${taskId}/dependencies/${dependsOnTaskId}`, json('DELETE')),
  deviceTypeCodes: () => request('/api/device-type-codes'),
  addDeviceTypeCode: (value) => request('/api/device-type-codes', json('POST', { value })),
  buildings: () => request('/api/buildings'),
  addBuilding: (value) => request('/api/buildings', json('POST', { value })),
