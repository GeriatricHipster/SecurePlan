...
test('store projects use the SecurePlan 0.10.0 release version', () => {
  assert.match(text('android/app/build.gradle'), /versionCode 5/);
  assert.match(text('android/app/build.gradle'), /versionName "0\.10\.0"/);
  assert.match(text('ios/App/App.xcodeproj/project.pbxproj'), /CURRENT_PROJECT_VERSION = 5;/);
  assert.match(text('ios/App/App.xcodeproj/project.pbxproj'), /MARKETING_VERSION = 0\.10\.0;/);
});
